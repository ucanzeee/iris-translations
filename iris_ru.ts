...
<context>
    ...
    <message>
        ...
        <translation>Ирис просто удалил некоторые ограничения видеоплаты. Вам необходимо перезагрузить компьютер один раз, чтобы разблокировать полную функциональность.</translation>
    </message>
    <message>
